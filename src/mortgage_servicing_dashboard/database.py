...
class Filing(Base):
    ...
    acceptance_timestamp: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
...
class SourceEvidence(Base):
    ...
    source_tool_version: Mapped[str | None] = mapped_column(String(32))
...
class RawXbrlFact(Base):
    ...
    source_sign: Mapped[str | None] = mapped_column(String(8))
    source_precision: Mapped[str | None] = mapped_column(String(32))
    presentation_sign: Mapped[str | None] = mapped_column(String(16))
